 ...
 * - change delivery fulfillment option (store under product management)
 *
 * order management
 * - cart management
 * - - add product to cart
 ...
 * - vendor accept or reject order (initiate refund when sellers reject order, reduce seller fulfillment score)
 * - confirm delivery (for sellers)
 * - attach billing address to order
 * - change delivery fulfillment option (store under order management)
 *
 * rating management
